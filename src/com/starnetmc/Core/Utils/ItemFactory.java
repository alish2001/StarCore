...
public class ItemFactory {
	...
	public static ItemStack createItem(Material item, String DName, HashMap<Enchantment, Integer> enchs){
		ItemStack i = new ItemStack(item);
		ItemMeta im = i.getItemMeta();
		im.setDisplayName(DName);
	...
	public static ItemStack createItem(Material item, String DName, List<String> lore, HashMap<Enchantment, Integer> enchs){
		ItemStack i = new ItemStack(item);
		ItemMeta im = i.getItemMeta();
		im.setDisplayName(DName);
		im.setLore(lore);
